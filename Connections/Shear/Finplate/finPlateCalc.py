...
##################################################################################
    ...
    print 'printing primary beam data'
    print  dictcolumndata 
...
#         new_bolt_param = boltDesign(bolt_shear_capacity_new)
    ...
    if web_plate_l == 0:
        ...
        if web_plate_l_opt > max_plate_height:
            ...
            logger.warning(": Minimum plate thickness required is %2.2f mm " % (max_plate_height))
    ...
    if web_plate_l == 0:
        min_plate_thk = fin_min_thk(shear_load,boltParameters['bolt_fy'],web_plate_l_opt);
        min_plate_thk = round(min_plate_thk,3);
